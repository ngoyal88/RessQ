...
<br><br><br>
    <table class="table">
        <thead>
            <tr>
                <th class="sr.no bg-danger"> Sr. No </th>
                <th class="blood-bank bg-danger">Blood Bank</th>
                <th class="category bg-danger"> Category</th>
                <th class="Availabilty bg-danger">Availablility </th>
                <th class=" last-updated bg-danger"> last Updated</th>
                <th class=" type bg-danger">Type</th>
            </tr>
        </thead>
        <tbody>
            <tr>
